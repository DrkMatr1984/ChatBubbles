...
public class PluginFile extends YamlConfiguration {   
    ...
    public void reload() {
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                Bukkit.getServer().getConsoleSender().sendMessage("Error while creating file " + file.getName());
            }
        ...
        try {
            ...
            exception.printStackTrace();
            Bukkit.getServer().getConsoleSender().sendMessage("Error while loading file " + file.getName());
    ...
    public void save() {
        ...
        try {
            ...
            exception.printStackTrace();
            Bukkit.getServer().getConsoleSender().sendMessage("Error while saving file " + file.getName());
        }
